...
def run_module():
    ...
    vmanage.result['imported'] = vmanage_files.import_templates_from_file(vmanage.params['file'], update=vmanage.params['update'], check_mode=module.check_mode, name_list = vmanage.params['name_list'], type = vmanage.params['type'])
